...
from model.layers import HierarchyFilter,StyleEncoder
...
class HierarchyFlow(nn.Module):
    def __init__(self,channel_list,n_block,**kwargs):
        ...
        for i in range(n_block - 1):
            self.blocks.append(HierarchyFilter(in_channel=channel_list[i], out_channel=channel_list[i+1],**kwargs))
