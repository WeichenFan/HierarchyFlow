...
class HdDataset(BaseDataset):
    def __init__(self, rootA, rootB, transform, transform_target, use_mc=False):
    ...
    def __getitem__(self, idx):
        ...
        source,_ = self.transform([source,deepcopy(source)])
        _,target = self.transform_target([deepcopy(target),target])
