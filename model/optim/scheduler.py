...
class cosineLR(_WarmUpLRScheduler):
    def __init__(self, optimizer, T_max, eta_min, base_lr, warmup_lr, warmup_steps, last_iter=-1):
        super(cosineLR, self).__init__(optimizer, base_lr, warmup_lr, warmup_steps, last_iter)
        self.sc =  torch.optim.lr_scheduler.CosineAnnealingLR(optimizer,T_max,eta_min)
