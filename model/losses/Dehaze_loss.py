...
class dehaze_loss(torch.nn.Module):
    def __init__(self,k,vgg_path='../model/losses/vgg_model/vgg_normalised.pth',weight_content=0.0,weight_style=1.0):
    ...
    def forward(self, content_images,style_images,stylized):
        l1_loss = nn.L1Loss()(stylized,style_images)
        loss_c, loss_s = self.encoder(content_images, style_images, stylized)
        return self.weight_content*loss_c + self.weight_style*loss_s + l1_loss
